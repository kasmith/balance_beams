...
BalTaskLogic = function(condition,ptobj,endfnc,debugging) {
    ...
    var condlist = "../static/json/condlist.json"
    ...
    */
    ...
    var thiscond = allconds[condition]

    this.trlist = shuffle(thiscond[1])

    this.intrlist = shuffle(thiscond[0]);
    this.tridx = 0;
